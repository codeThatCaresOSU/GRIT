...
protocol BasicsSeventhPageDelegate {
    func dismiss_basics_last()
}

protocol BasicsLastBackToFirst {
    func back_to_front()
}

class BasicsSeventhPage : UIViewController {
    
    var delegate: BasicsSeventhPageDelegate! = nil
    var redelegate: BasicsLastBackToFirst! = nil
    ...
    @objc func last_dismiss() {
        self.delegate.dismiss_basics_last()
    }
    
    @objc func back() {
        self.redelegate.back_to_front()
    }
}
